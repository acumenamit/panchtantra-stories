const crowAndSerpent = {
  ...
  nodes: {
    start: {
      ...
      question: {
        en: `Should the crow attack the serpent directly — defending his home with everything he has?\n... Or... should he seek advice from a wiser friend before acting at all?`,
        hi: `क्या कौए को सीधे साँप पर हमला करना चाहिए — अपने घर की रक्षा अपनी पूरी ताक़त से?\n... या... क्या उसे कुछ भी करने से पहले किसी बुद्धिमान मित्र से सलाह लेनी चाहिए?`,
      },
      },
      choices: [
        { text: { en: '⚔️ Attack the serpent directly — defend your home!',         hi: '⚔️ सीधे साँप पर हमला करो — अपने घर की रक्षा करो!' },   next: 'direct_attack' },
        { text: { en: '🦊 Seek advice from a wiser friend before acting',            hi: '🦊 कार्य करने से पहले किसी बुद्धिमान मित्र से सलाह लो' }, next: 'seek_advice' },
      ],
    },
    ...
    direct_attack: {
      ...
      question: {
        en: `Must courage always be paired with strategy — because knowing how to fight matters as much as the will to fight?\n... Or... is it allies that make the difference — because no one wins the hardest battles alone?`,
        hi: `क्या साहस हमेशा नीति के साथ होना चाहिए — क्योंकि कैसे लड़ना है यह जानना उतना ही ज़रूरी है जितना लड़ने की इच्छा?\n... या... क्या फर्क साथियों से पड़ता है — क्योंकि सबसे कठिन लड़ाई कोई अकेले नहीं जीतता?`,
      },
      },
      choices: [
        { text: { en: '🧠 Strategy — knowing HOW to fight matters as much as the will to fight', hi: '🧠 नीति — यह जानना कि कैसे लड़ना है उतना ही महत्वपूर्ण है जितना लड़ने की इच्छाशक्ति' }, next: 'seek_advice' },
        { text: { en: '🤝 Allies — no one wins the hardest battles alone',                      hi: '🤝 साथी — कोई भी सबसे कठिन लड़ाई अकेले नहीं जीतता' },                              next: 'seek_advice' },
      ],
    },
    ...
    seek_advice: {
      ...
      question: {
        en: `Does pride and greed truly blind even the strongest enemy — making them careless and easy to trap?\n... Or... is it possible that some enemies have no weakness at all?`,
        hi: `क्या अहंकार और लालच सच में सबसे शक्तिशाली दुश्मन को भी अंधा कर देते हैं — उसे लापरवाह और आसान शिकार बना देते हैं?\n... या... क्या यह संभव है कि कुछ दुश्मनों की कोई कमज़ोरी ही नहीं होती?`,
      },
      },
      choices: [
        { text: { en: '✅ Yes — pride and greed blind even the strongest',          hi: '✅ हाँ — अहंकार और लालच सबसे मज़बूत को भी अंधा कर देते हैं' }, next: 'the_plan' },
        { text: { en: '🤔 Maybe — but what if the enemy has no weakness at all?', hi: '🤔 शायद — लेकिन क्या होगा अगर दुश्मन की कोई कमज़ोरी ही न हो?' }, next: 'the_plan' },
      ],
    },
    ...
    the_plan: {
      ...
      question: {
        en: `Will the guards find the serpent coiled beside the necklace — and deal with him once and for all?\n... Or... could something go wrong, leaving the crow in trouble instead?`,
        hi: `क्या रक्षक साँप को हार के पास कुंडली मारे पाएंगे — और उससे हमेशा के लिए निपटेंगे?\n... या... क्या कुछ गलत हो सकता है, और कौए को इसके बजाय मुसीबत में डाल सकता है?`,
      },
      },
      choices: [
        { text: { en: '😮 The guards will find the serpent — and deal with him!',          hi: '😮 रक्षक साँप को पाएंगे — और उससे निपटेंगे!' },           next: 'plan_works' },
        { text: { en: '😬 What if the plan goes wrong and the crow gets in trouble?', hi: '😬 क्या होगा अगर योजना गलत हो जाए और कौए को परेशानी हो?' }, next: 'plan_risk' },
      ],
    },
    ...
    plan_risk: {
      ...
      question: {
        en: `Did careful thinking make all the difference — using the enemy's own nature against him?\n... Or... was it the value of a wise friend — without the jackal's counsel, none of this would have worked?`,
        hi: `क्या सावधानीपूर्वक सोच ने सब कुछ बदल दिया — दुश्मन की अपनी प्रकृति को उसके खिलाफ इस्तेमाल करके?\n... या... क्या एक बुद्धिमान मित्र की कीमत थी — सियार की सलाह के बिना यह कुछ भी काम नहीं करता?`,
      },
      },
      choices: [
        { text: { en: '🎯 Careful thinking — the plan used the enemy\'s own nature against him', hi: '🎯 सावधानीपूर्वक सोच — योजना ने दुश्मन की अपनी प्रकृति को उसके खिलाफ इस्तेमाल किया' }, next: 'ending_wisdom' },
        { text: { en: '🤝 Good counsel — never underestimate the value of a wise friend',       hi: '🤝 अच्छी सलाह — एक बुद्धिमान मित्र के मूल्य को कभी कम मत आँको' },                  next: 'ending_counsel' },
      ],
    },
    ...
    plan_works: {
      ...
      question: {
        en: `Was this strategic thinking — understanding the whole situation, not just the fight in front of you?\n... Or... was it the wisdom of a good friend — the jackal's counsel that made all the difference?`,
        hi: `क्या यह रणनीतिक सोच थी — सिर्फ सामने की लड़ाई नहीं, पूरी स्थिति को समझना?\n... या... क्या यह एक अच्छे मित्र की बुद्धि थी — सियार की सलाह जिसने सब कुछ बदल दिया?`,
      },
      },
      choices: [
        { text: { en: '♟️ Strategic thinking — understanding the whole situation, not just the fight', hi: '♟️ रणनीतिक सोच — सिर्फ लड़ाई नहीं, पूरी स्थिति को समझना' }, next: 'ending_wisdom' },
        { text: { en: '🦊 Wisdom from friends — the jackal\'s counsel made all the difference',      hi: '🦊 मित्रों की बुद्धि — सियार की सलाह ने सब कुछ बदल दिया' },              next: 'ending_counsel' },
      ],
    },
